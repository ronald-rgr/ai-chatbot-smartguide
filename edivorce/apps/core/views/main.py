...
def send_message(request):
    ...
    message = body_unicode
    new_string = message.replace("+"," ")
    new_string = new_string.replace("message=","")
    
    print(message)
    print(new_string)
    project_id = 'ai-poc-smartguide'
    fulfillment_text = detect_intent_texts(project_id, "unique", new_string, 'en')
